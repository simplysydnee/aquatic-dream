      ...
      <div>
        ...
        {SELF_SERVE_CARD_REUSE_ENABLED && reuseCard && (
          <div className="max-w-2xl mx-auto mb-4 p-3 border border-primary/30 bg-primary/5 rounded-lg text-sm">
            <p>
              Saved card found: <strong>{reuseCard.brand.toUpperCase()} •••• {reuseCard.last4}</strong>
            ...
            <div className="mt-3 flex flex-col sm:flex-row gap-2">
              <Button
                type="button"
                size="sm"
                variant={useReuse ? "default" : "outline"}
                onClick={() => setUseReuse(true)}
              >
                Use this card
              </Button>
              <Button
                ...
                size="sm"
                variant={!useReuse ? "default" : "outline"}
                onClick={() => setUseReuse(false)}
              >
                Enter a new card instead
              </Button>
            </div>
          </div>
        )}
