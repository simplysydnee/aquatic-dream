...
const RegistrationFeePaymentLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Registration fee {amountDue ? `(${amountDue}) ` : ''}for {childName || 'your swimmer'} — {SITE_NAME}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          To complete the enrollment, please pay the one-time
          {amountDue ? <> <strong>{amountDue}</strong></> : ''} registration fee using the secure
          link below.
        </Text>
        {sessionInfo && (
...
export const template = {
  ...
  subject: (data: Record<string, any>) => {
    ...
    return `Registration Fee Due${who} — ${SITE_NAME}`
  },
